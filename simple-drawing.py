...
def circularShape(doc): 
	...
	doc.Cylinder.Radius=40.00
	doc.Cylinder.Height=100.00
	doc.Cylinder.Angle=360.00
	doc.Cylinder.Placement = App.Placement(App.Vector(50,50,0), App.Rotation(0,0,0))

	# Cut the fused shapes from the first box
	doc.addObject("Part::Cut","Shape")
	doc.Shape.Base = App.ActiveDocument.Box 
	doc.Shape.Tool = App.ActiveDocument.Cylinder
...
def draw(doc, templatePath):
	...
	doc.FrontView.Source = [doc.Shape]
	...
	doc.RightView.Source = [doc.Shape]    
...
shape(doc)
draw(doc, 'Templates/A1_Landscape_plain.svg')
doc.recompute()
